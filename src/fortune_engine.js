...
const EASTERN_TEMPLATES = {
    ...
    actions: [
        "오늘은 붉은색 계열의 옷이나 소품을 걸치면 기운이 북돋아지는데, 가족 모두 빨간 양말이나 손수건 같은 작은 아이템을 하나씩 챙겨보세요.",
        "동쪽 방향으로 가족과 함께 산책을 다녀오면 좋은 기운을 받을 수 있고, 함께 걸으며 대화를 나누다 보면 하루가 더 화목해집니다.",
        "따뜻한 차를 천천히 마시며 마음을 가라앉히는 시간을 가져보세요. 저녁에 가족이 함께 차 한 잔씩 나눠 마시면 대화가 자연스럽게 이어집니다.",
        "약속 시간보다 10분 일찍 도착하면 하루 전체에 여유가 생기는데, 온 가족이 일찍 준비하는 습관을 들이면 아침이 평화로워집니다.",
        "지갑을 정리하고 묵은 영수증을 버리면 금전운이 트이기 시작하는데, 가족 모두 각자의 지갑을 함께 정리해보면 돈 관리 의식도 높아집니다.",
        "부모님이나 조부모님께 온 가족이 함께 안부 전화를 드리면 마음이 포근해지고, 세대 간 유대감도 깊어지는 소중한 시간이 됩니다.",
        "오늘 점심은 국수나 쫄면처럼 길쭉한 면 요리로 드시면 길운이 따르는데, 가족이 함께 식탁에 둘러앉아 먹으면 더욱 좋습니다.",
        "잠들기 전 저녁 식사 자리에서 오늘 감사했던 일을 가족이 돌아가며 한 가지씩 이야기해보세요. 긍정의 에너지가 집안에 가득 차오릅니다.",
        "아침에 기상하자마자 따뜻한 물 한 잔씩 마시면 하루를 가볍게 시작할 수 있고, 가족 모두의 건강에도 좋으니 습관으로 만들어보세요.",
        "온 가족이 각자 자기 공간을 10분씩 정돈하면 머리가 맑아지고 집중력이 높아지는데, 정리된 공간은 정리된 마음을 만들어줍니다.",
        "엘리베이터 대신 계단을 이용하면 건강운이 함께 올라가니, 아파트에 사신다면 가족이 함께 몇 층이라도 걸어 올라가는 습관을 들여보세요.",
        "오늘 하루는 채소 위주로 식사하면 몸이 한결 가볍고 상쾌해지는데, 저녁 식탁에 신선한 채소를 듬뿍 준비하면 가족 건강에 좋습니다.",
        "좋아하는 향수를 뿌리거나 거실에 은은한 향초를 켜두면 집안 분위기가 부드러워지고, 가족 모두의 기분이 차분하게 안정됩니다.",
        "아침에 거울을 보며 환하게 웃는 연습을 온 가족이 함께 해보세요. 표정이 밝아지면 하루 종일 좋은 일이 찾아오는 기분이 듭니다.",
        "주말에 가까운 화원에 가족이 함께 들러 작은 화분 하나를 골라 집으로 들이면, 식물을 함께 키우며 생명의 소중함도 느낄 수 있어요.",
        "오늘은 평소보다 조금 일찍 귀가하여 가족과 편안한 저녁 시간을 보내세요. 함께 TV를 보거나 게임을 하는 것만으로도 충분합니다.",
        "집안에서 더 이상 필요하지 않은 물건을 가족 회의를 통해 골라내어 정리하거나 기부하면, 공간도 넓어지고 마음도 가벼워집니다.",
        "주말 오후 하늘 사진을 가족이 함께 찍어보세요. 시야가 확 트이는 기분이 들고, 함께 자연을 관찰하는 좋은 시간이 됩니다.",
        "식사 후 온 가족이 거실에서 5분씩 스트레칭을 함께하면 굳은 몸이 풀리고, 함께 움직이는 즐거움도 느낄 수 있습니다.",
        "평소 듣지 않던 클래식이나 재즈 같은 장르의 음악을 가족이 함께 들어보면 새로운 문화 경험이 되고, 정서에도 좋은 영향을 줍니다.",
        "가족끼리 손편지를 쓰는 시간을 가져보세요. 한 달에 한 번 편지를 교환하면 정성이 담긴 글이 오래도록 마음에 남습니다.",
        "오늘은 가족 모두 스마트폰 사용 시간을 평소보다 30분씩 줄이고, 그 시간에 얼굴 보며 대화를 나눠보세요. 관계가 더 돈독해집니다.",
        "남쪽으로 머리를 두고 잠자리에 들면 깊은 숙면을 취할 수 있으니, 가족 모두 침대 방향을 한번 확인해보고 조정해보는 것이 좋습니다.",
        "보름달이 뜬 날 저녁, 가족이 함께 베란다나 창가에서 달을 보며 각자의 소원을 조용히 빌어보세요. 간절한 마음은 언젠가 이루어집니다.",
        "저녁 시간에 따뜻한 물로 가족이 돌아가며 족욕을 하면 하루의 피로가 말끔히 풀리고, 온 가족의 숙면에도 큰 도움이 됩니다.",
        "출퇴근이나 외출할 때 평소와 다른 새로운 길을 선택해보면 신선한 자극을 받게 되는데, 주말에는 가족이 함께 새로운 동네를 탐험해보세요.",
        "휴대폰 연락처 목록을 정리하며 오랫동안 연락하지 않은 지인은 과감히 정리하면, 진짜 소중한 인연에 더 집중할 수 있게 됩니다.",
        "제철 과일을 장바구니에 가득 담아 식후 디저트로 가족이 함께 나눠 먹으면, 자연의 기운과 함께 건강과 행운이 들어옵니다.",
        "주말에 온 가족이 서점이나 도서관에 함께 가서 각자 마음에 드는 책을 한 권씩 골라보세요. 책을 통한 대화 소재가 생깁니다.",
        "오늘 하루는 온 가족이 부정적인 말을 하지 않기로 약속하고, 긍정적이고 따뜻한 말만 사용해보세요. 집안 분위기가 확 달라집니다.",
        "작은 금액이라도 함께 기부하거나 이웃을 돕는 선행을 가족이 함께 실천하면, 나눔의 가치를 함께 배우고 복도 돌아옵니다.",
        "아침 햇살이 드는 시간에 창문을 활짝 열고 온 가족이 함께 심호흡을 5번씩 해보세요. 기분이 한결 맑아지고 긍정 에너지가 가득 차오릅니다.",
        "현관 신발을 가족 모두가 가지런히 정돈하는 습관을 들이면 집안에 좋은 기운이 머물고, 정리하는 습관도 자연스럽게 몸에 배게 됩니다.",
        "물을 충분히 마시는 것이 건강의 기본인데, 가족 모두 하루 8잔씩 마시기 목표를 정하고 서로 체크해주면 재미있고 건강해집니다.",
        "조부모님이나 친척 어른을 모시고 온 가족이 함께 식사하는 자리를 마련해보세요. 어른을 공경하는 마음을 배우고 가족 간 유대가 깊어집니다.",
        "아침마다 창문을 활짝 열어 10분간 환기하면 밤새 쌓인 탁한 기운이 빠져나가고, 신선한 공기가 들어와 하루가 상쾌하게 시작됩니다.",
        "대중교통에서 자리를 양보하는 모습을 가족이 함께 실천하면, 말로 하는 교육보다 효과적이고 보는 사람에게도 감동을 줍니다.",
        "바쁜 평일에도 최소 주 3회는 온 가족이 식탁에 둘러앉아 저녁을 함께 먹으려 노력해보세요. 함께하는 식사가 가족을 하나로 묶어줍니다.",
        "빌렸던 물건이나 책을 정리해서 제때 돌려주고, 가족 모두 약속을 지키는 습관을 들이면 신용과 신뢰가 쌓입니다.",
        "화장실을 온 가족이 돌아가며 청소하고 항상 깨끗하게 유지하면 나쁜 기운이 빠져나가고, 함께 청결을 유지하는 책임감도 생깁니다.",
        "오래 미뤄두었던 사과나 감사 인사를 가족 앞에서 전하는 모습을 보여주면, 서로에게 용기 내어 마음을 표현하는 문화가 만들어집니다.",
        "가까운 공원을 가족이 함께 천천히 산책하며 나무와 하늘을 보면, 자연의 기운을 받고 일상의 스트레스가 자연스럽게 풀립니다.",
        "규칙적으로 일찍 자는 습관을 온 가족이 함께 들이면 건강 리듬이 좋아지고, 아침에 일어나는 것도 한결 수월해집니다.",
        "현관 바닥을 소금물로 닦으면 액운이 물러가고 좋은 기운이 들어오는데, 주말에 가족이 함께 대청소하면 협동심도 기를 수 있어요.",
        "낡은 수건이나 속옷, 양말을 새것으로 바꾸면 기운이 새로워지니, 계절이 바뀔 때마다 가족 모두의 생활용품을 점검해보세요.",
        "냉장고 속 유통기한 지난 식품을 가족이 함께 정리하면 재물운이 좋아지고, 음식을 아끼고 소중히 하는 마음도 기를 수 있습니다.",
        "오늘 만나는 사람에게 가족 모두 먼저 밝게 인사하는 연습을 해보세요. 밝은 인사는 좋은 인연을 불러오고 주변을 환하게 만듭니다.",
        "집 안 거울을 깨끗이 닦으면 얼굴에 화색이 돌고 운기가 밝아지는데, 주말에 가족이 함께 집안 곳곳 거울을 닦아보는 것도 좋습니다.",
        "귀가 후 온 가족이 손발을 깨끗이 씻고 편한 옷으로 갈아입는 습관을 들이면, 외부의 나쁜 기운을 집안으로 들이지 않게 됩니다.",
        "베란다나 창가의 먼지를 털어내고 유리창을 닦으면 답답함이 사라지고 밝은 기운이 들어오니, 한 달에 한 번은 온 가족이 함께 청소해보세요.",
        "오늘은 흰색이나 베이지색 계열 옷을 입고 외출하면 평온함이 찾아오는데, 가족 모두 비슷한 톤의 옷을 입으면 더욱 화목한 분위기가 납니다.",
        "가족이 하루 일과를 이야기할 때 끝까지 경청하며 눈을 맞춰주면, 서로 존중받는다는 느낌을 받고 소통이 활발해집니다.",
        "현관에 따뜻한 조명을 밝혀두면 집안에 온기가 돌고, 늦은 시간 귀가하는 가족이 집에 들어설 때 포근함을 느끼게 됩니다.",
        "집 안 벽시계가 제대로 작동하는지 확인하고 배터리를 교체해주면, 시간의 흐름이 순조로워지고 가족 모두의 일정이 순탄해집니다.",
        "오래된 화장품이나 약품, 구급상자를 정리하고 새것으로 보충하면 건강운이 상승하고, 가족의 안전과 건강에도 더 신경 쓰게 됩니다.",
        "아침 기상 후 온 가족이 각자 이불을 개고 창문을 열어 환기하는 습관을 들이면, 하루를 깔끔하게 시작하는 기분 좋은 루틴이 생깁니다.",
        "서랍 속 엉킨 충전기나 전선을 가족이 함께 정돈하면 복잡한 마음도 정리되고, 물건을 소중히 관리하는 습관도 자연스럽게 생깁니다.",
        "오늘은 식사량을 평소보다 조금 줄이고 소식하는 연습을 온 가족이 함께하면, 소화도 잘되고 건강에도 좋으며 절제하는 법을 배우게 됩니다.",
        "길에서 이웃이나 아는 분을 마주쳤을 때 온 가족이 함께 밝게 인사하면, 예의를 실천하고 동네에서 좋은 평판을 얻게 됩니다.",
        "저녁 시간에 집 안 구석구석 조명을 환하게 켜두면 어두운 기운이 사라지고, 가족 모두가 밝은 에너지 속에서 편안하게 시간을 보낼 수 있습니다.",
        "거실이나 각 방의 화분에 물을 주면서 가족이 돌아가며 식물에게 좋은 말을 건네보세요. 생명을 존중하는 마음이 집안에 생기를 불어넣습니다.",
        "오늘은 커피나 탄산음료 대신 구수한 숭늉, 보리차, 옥수수차를 온 가족이 함께 마시면 몸이 편안해지고 소화도 잘됩니다.",
        "거실에 가족 사진을 꺼내 놓고 함께 앨범을 보며 행복했던 순간을 이야기해보세요. 추억을 나누다 보면 서로에 대한 사랑이 더 깊어집니다.",
        "집 안에 깨진 그릇이나 고장 난 가전제품이 있다면 빨리 수리하거나 버리세요. 손상된 물건은 나쁜 기운을 불러오고 집안 분위기를 침체시킵니다.",
        "현관 매트나 발판을 햇볕에 말리고 털어내면 집안으로 들어오는 기운이 맑아지고, 가족 모두가 깨끗한 에너지를 받으며 들어올 수 있습니다.",
        "오늘 저녁은 조명을 조금 어둡게 하고 온 가족이 함께 조용히 차분한 시간을 보내보세요. 밝은 조명보다 은은한 빛이 마음을 안정시켜줍니다.",
        "배달 음식을 받거나 택배를 받을 때 가족 모두 기사님께 고맙다는 인사를 전하세요. 감사를 표현하는 습관은 삶을 더 풍요롭게 만듭니다.",
        "화장실 변기 뚜껑을 사용 후 항상 닫고 문도 닫아두는 습관을 들이면 재물이 빠져나가지 않고, 집안 기운도 안정적으로 유지됩니다.",
        "오늘은 노란색이나 금색 소품을 가족 모두 하나씩 지니고 다니면 금전운이 따르는데, 작은 액세서리나 문구류도 좋습니다.",
        "주말에 온 가족이 함께 집 안 곳곳의 먼지를 털고 쓸어내면 탁한 기운이 빠져나가고, 협동 작업을 통해 가족 유대감도 강해집니다.",
        "멀리 사는 형제자매나 가까운 친척에게 안부 메시지를 보내고, 온 가족이 친척들과 연락하며 지내면 가족 간 끈끈한 정이 유지됩니다.",
        "신발장을 정리하고 신지 않는 낡은 신발은 과감히 버리세요. 현관이 깔끔해지면 새로운 기회가 들어오고 가족의 발걸음도 가벼워집니다.",
        "저녁 식사 후 설거지를 온 가족이 함께하며 오늘 있었던 일을 이야기 나눠보세요. 함께 일하며 대화하는 시간이 가족을 더 가깝게 만듭니다.",
        "거실이나 식탁에서 은은한 클래식 음악이나 잔잔한 연주곡을 틀어놓으면 집안 분위기가 부드러워지고, 마음의 안정을 찾는 데 도움이 됩니다.",
        "오늘은 녹색 계열 옷이나 소품을 가족 모두 착용하면 안정과 치유의 기운을 받게 되는데, 자연의 색은 마음을 편안하게 해줍니다.",
        "잠들기 전 가족이 거실에 모여 오늘 하루 좋았던 일을 한 가지씩 이야기하고, 긍정적인 생각으로 마음을 채운 뒤 잠자리에 들면 좋은 꿈을 꿉니다.",
        "집 안 시든 꽃이나 말라버린 관엽식물은 바로 치워주고 생기 있는 식물로 교체하세요. 생명력 없는 것들은 집안 기운을 떨어뜨립니다.",
        "저녁 식사 전 온 가족이 잠시 조용히 앉아 서로의 건강과 행복을 위해 마음속으로 기도하거나 좋은 기운을 빌어보세요. 간절한 마음은 통합니다.",
        "하루를 마무리하며 오늘 만났던 모든 사람들, 특히 가족에게 감사한 마음을 품어보세요. 감사는 더 많은 행복을 불러오는 가장 강력한 주문입니다.",
        "현관 대문이나 신발장 주변을 온 가족이 함께 깨끗이 쓸고 닦으면 복이 들어올 준비가 완료되고, 협동하는 모습에서 가족애가 깊어집니다."
    ]
};
